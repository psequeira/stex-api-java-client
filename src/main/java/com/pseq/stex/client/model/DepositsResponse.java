...
import com.pseq.stex.client.model.Deposit;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-05-02T20:38:18.888Z[GMT]")public class DepositsResponse {
  ...
  public DepositsResponse success(Boolean success) {
  ...
  **/
  ...
  public DepositsResponse data(List<Deposit> data) {
    this.data = data;
    return this;
  }

  public DepositsResponse addDataItem(Deposit dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Deposit>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DepositsResponse depositsResponse = (DepositsResponse) o;
    return Objects.equals(this.success, depositsResponse.success) &&
        Objects.equals(this.data, depositsResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepositsResponse {\n");
