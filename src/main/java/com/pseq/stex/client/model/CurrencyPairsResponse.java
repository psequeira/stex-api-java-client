...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-05-02T20:38:18.888Z[GMT]")public class CurrencyPairsResponse {
  ...
  private List<CurrencyPair> data = null;
  public CurrencyPairsResponse success(Boolean success) {
  ...
  **/
  ...
  public CurrencyPairsResponse data(List<CurrencyPair> data) {
    this.data = data;
    return this;
  }

  public CurrencyPairsResponse addDataItem(CurrencyPair dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<CurrencyPair>();
    }
  ...
  **/
  @Schema(description = "")
  public List<CurrencyPair> getData() {
    return data;
  }
  public void setData(List<CurrencyPair> data) {
    this.data = data;
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    CurrencyPairsResponse currencyPairsResponse = (CurrencyPairsResponse) o;
    return Objects.equals(this.success, currencyPairsResponse.success) &&
        Objects.equals(this.data, currencyPairsResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyPairsResponse {\n");
