...
import com.pseq.stex.client.model.Withdrawal;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-05-02T20:38:18.888Z[GMT]")public class WithdrawalsResponse {
  ...
  private List<Withdrawal> data = null;
  public WithdrawalsResponse success(Boolean success) {
  ...
  **/
  ...
  public WithdrawalsResponse data(List<Withdrawal> data) {
    this.data = data;
    return this;
  }

  public WithdrawalsResponse addDataItem(Withdrawal dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Withdrawal>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.success, withdrawalsResponse.success) &&
        Objects.equals(this.data, withdrawalsResponse.data);
  }
