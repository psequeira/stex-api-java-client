...
import com.pseq.stex.client.model.Candle;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-05-02T20:38:18.888Z[GMT]")public class CandlesResponse {
  ...
  private List<Candle> data = null;
  public CandlesResponse success(Boolean success) {
  ...
  **/
  ...
  public CandlesResponse data(List<Candle> data) {
    this.data = data;
    return this;
  }

  public CandlesResponse addDataItem(Candle dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Candle>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.success, candlesResponse.success) &&
        Objects.equals(this.data, candlesResponse.data);
  }
