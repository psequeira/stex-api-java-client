...
import com.pseq.stex.client.model.DeletedOrders;
import io.swagger.v3.oas.annotations.media.Schema;

/**
 * DeletedOrdersResponse
 */

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-05-02T20:38:18.888Z[GMT]")public class DeletedOrdersResponse {
  ...
  private DeletedOrders data = null;
  public DeletedOrdersResponse success(Boolean success) {
  ...
  **/
  ...
  public DeletedOrdersResponse data(DeletedOrders data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public DeletedOrders getData() {
    return data;
  }
  public void setData(DeletedOrders data) {
    this.data = data;
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    DeletedOrdersResponse deletedOrdersResponse = (DeletedOrdersResponse) o;
    return Objects.equals(this.success, deletedOrdersResponse.success) &&
        Objects.equals(this.data, deletedOrdersResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeletedOrdersResponse {\n");
