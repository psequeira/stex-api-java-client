...
import com.pseq.stex.client.model.Trade;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-05-02T20:38:18.888Z[GMT]")public class TradesResponse {
  ...
  public TradesResponse success(Boolean success) {
  ...
  **/
  ...
  public TradesResponse data(List<Trade> data) {
    this.data = data;
    return this;
  }

  public TradesResponse addDataItem(Trade dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Trade>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TradesResponse tradesResponse = (TradesResponse) o;
    return Objects.equals(this.success, tradesResponse.success) &&
        Objects.equals(this.data, tradesResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class TradesResponse {\n");
