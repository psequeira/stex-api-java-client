...
import com.pseq.stex.client.model.Ticker;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-05-02T20:38:18.888Z[GMT]")public class TickersResponse {
  ...
  private List<Ticker> data = null;
  public TickersResponse success(Boolean success) {
  ...
  **/
  ...
  public TickersResponse data(List<Ticker> data) {
    this.data = data;
    return this;
  }

  public TickersResponse addDataItem(Ticker dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Ticker>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TickersResponse tickersResponse = (TickersResponse) o;
    return Objects.equals(this.success, tickersResponse.success) &&
        Objects.equals(this.data, tickersResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class TickersResponse {\n");
